...
-I think the most important part of code reviews would be correcting it in a way
 that encourages improvement.
-Yes, this is something that I always implement when reviewing other people's
 code.
-Absolutely, this is the most important aspect of code reviewing in my opinion
 so of course I would like it done to me.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

-Containers are a easy way to build, test, and deploy applications on diffrent
 environments.
-Containers also allow for repeatability.
